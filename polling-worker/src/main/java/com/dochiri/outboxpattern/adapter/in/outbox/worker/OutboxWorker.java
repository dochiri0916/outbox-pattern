...
import com.dochiri.outboxpattern.application.outbox.failure.OutboxFailureClassifier;
...
public class OutboxWorker {
    ...
    public void runOnce() {
        try {
            for (int i = 0; i < outboxWorkerProperties.batchSize(); i++) {
                ...
                OutboxProcessingContext processingEvent;
                try {
    ...
    private void process(OutboxProcessingContext processingEvent) {
    ...
    private ScheduledFuture<?> startLeaseHeartbeat(OutboxProcessingContext processingEvent) {
    ...
    private void sendLeaseHeartbeat(OutboxProcessingContext processingEvent) {
        try {
